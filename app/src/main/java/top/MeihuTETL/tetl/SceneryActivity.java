...
public class SceneryActivity extends AppCompatActivity {
    ...
    //定义数组，用于通讯录数据
    private String[] names={"郑大新区南门","行政楼远景","钟楼","图书馆","图书馆远景","眉瑚","教学楼","厚德大道"};
    private int[] imgs={R.drawable.school_zzu1,R.drawable.school_zzu2,R.drawable.school_zzu3,R.drawable.school_zzu4,R.drawable.school_zzu5,
            R.drawable.school_zzu6,R.drawable.school_zzu7,R.drawable.school_zzu8};
